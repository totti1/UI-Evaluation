...
class Textable extends Component {
  constructor (props) {
    super(props)
  ...
  *************************************************************/
  renderRow (rowData, sectionID) {
    ...
    return (
      <TouchableOpacity style={styles.row} onPress={()=> Clipboard.getString(rowData.art)}>
  ...
  *************************************************************/
  ...
  renderHeader (data, sectionID) {
    return <View style={styles.sectionHeader}><Text style={styles.title}>{sectionID}</Text></View>
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(Textable)
